...
# 记录时间步
        ...
        reward_trajectory.append(cumulative_reward)
    ...
    state.reward_trajectory = reward_trajectory
    return state
...
# naive_qwen_alf strong_qwen_alf
# edit this
    output_path = os.path.join("/home/bhui/ML/ruimeng/ETO-main/13B_TreeDpo_sciworld_test", agent_config['config']['model_name'].replace('/', '_'), args.exp_config+args.exp_name)

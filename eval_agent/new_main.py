...
# naive_qwen_alf strong_qwen_alf
    output_path = os.path.join("/home/bhui/ML/ruimeng/ETO-main/mcts_13B_sci_test_time_step", agent_config['config']['model_name'].replace('/', '_'), args.exp_config+args.exp_name)

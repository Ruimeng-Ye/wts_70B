...
# # 设置训练参数
# training_args = TrainingArguments(
#     output_dir="/home/bhui/ML/ruimeng/ETO-main/dpo_output/DPO_wts_llama8B_webshop_ref_13B",
#     num_train_epochs=3,
...
# # 政策模型的基础路径（SFT 后的 LLaMA3 8B 模型）
# base_model_path = "/home/bhui/ML/ruimeng/ETO-main/llama8B_webshop_output/lora_sft_strong_model/merged_model"

# # 参考模型的路径（SFT 后的 LLaMA 13B 模型）
# ref_model_path = "/home/bhui/ML/ruimeng/ETO-main/webshop_output/lora_sft_strong_llama2_web_v1/merged_model"  # 请替换为实际的模型路径
